...
class Order(models.Model):
    ...
    billing_name = models.CharField(max_length=60, default="None")
    billing_address1 = models.CharField(max_length=60, default="None")
    billing_address2 = models.CharField(
        max_length=60, blank=True, default="None"
    )
    billing_zip_code = models.CharField(max_length=12, default="None")
    billing_city = models.CharField(max_length=60, default="None")
    billing_country = models.CharField(max_length=3, default="N")
